...
public class Host {
	...
	/**
	 * Creates a host with a given ID, but only if that host has previously been
	 * generated previously with the standard constructor. (This is to allow making
	 * host objects that are equal to each other, but not hosts with id numbers out
	 * of sequence.)
	 * 
	 * @param id
	...
	/**
	 * Sets the hashcode of the host to be a hash of the string value which contains
	 * the id.
	 * 
	...
	/**
	 * The string representation of a host is it's IPv4 address.
	 * 
	...
	/**
	 * This is a code pattern called a "factory". A factory for hosts makes
	 * instances of hosts!
	 * 
