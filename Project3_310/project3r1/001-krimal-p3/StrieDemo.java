...
/**
 * This method runs the demo of Strie.
 * 
 * @author 310 professors
 *
 */
public class StrieDemo {
	/**
	 * Main method for StrieDemo class which takes in array of string.
	 * 
	 * @param args
	 *            - Array of string.
	 */
		...
		while (true) {
			...
			try {
				...
				case 2:
					...
					if (isFound == true)
						System.out.println("Your Strie contains this word!");
					else
						System.out.println("Your strie doesn't contain this word!");
					break;
				case 3:
					System.out.print("Enter a word: ");
					word = in.nextLine().trim();
					...
					if (removed == true)
						System.out.println("Word removed from Strie");
					else if (removed == false)
						System.out.println("Invalid character entered. Characters must be between 'a' and 'z' ");
	...
	/**
	 * This method prints the menu for user to enter their choice.
	 * 
	 * @param in
	 *            - Takes in scanner input.
	 * @return The integer what user has entered.
	 */
